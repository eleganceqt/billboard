...
class billboardPartnersShowAllController extends billboardJsonController
{
    ...
    public function execute()
    {
        if (! $this->failsValidation()) {
            $this->showPartnersAdverts();
        }
    }

    protected function showPartnersAdverts()
    {
        $this->model('advert')->showByPartner($this->request['id']);
    }
